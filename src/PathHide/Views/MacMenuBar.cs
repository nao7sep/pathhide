...
internal static class MacMenuBar
{
    ...
    // The actions PathHide answers itself; every other action is AppKit's own. Quit shuts down
    ...
    /// glued on, because where the name sits in "About PathHide" differs between languages.
    /// </summary>
